...
export const WaterTreatment = () => (
  <ServicePage
    ...
    description="Профессиональная экспертиза, технический аудит и оценка состояния инженерных систем"
    details="Мы проводим комплексную экспертизу инженерных систем промышленных и коммерческих объектов. Наши специалисты выполняют технический аудит, оценивают текущее состояние оборудования, выявляют неисправности и потенциальные риски, готовят детальные заключения с рекомендациями по модернизации и оптимизации."
    features={[
      "Технический аудит инженерных систем объекта",
      "Оценка состояния и остаточного ресурса оборудования",
      "Энергоаудит и анализ энергоэффективности",
      "Выявление дефектов, рисков и нарушений в эксплуатации",
      "Подготовка экспертных заключений и отчётов",
