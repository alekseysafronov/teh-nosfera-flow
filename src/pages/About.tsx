    ...
    <section className="py-16">
      <div className="container max-w-5xl grid md:grid-cols-2 gap-10 items-center">
        <div className="space-y-6 text-muted-foreground leading-relaxed">
          ...
          <p>
            Компанию возглавляет <strong className="text-foreground">Хмельков Дмитрий Викторович</strong>, директор с большим опытом работы в сфере эксплуатации инженерных систем (25+ лет опыта).
          </p>
        </div>
