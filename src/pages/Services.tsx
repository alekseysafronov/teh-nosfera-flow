...
const services = [
  { icon: Droplets, title: "Экспертиза инженерных систем", desc: "Профессиональная экспертиза, технический аудит и оценка состояния инженерных систем объекта. Подготовка заключений и рекомендаций.", path: "/services/water-treatment" },
